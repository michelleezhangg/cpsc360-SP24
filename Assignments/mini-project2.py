...
whichQuestion = 3                                                           # 1: run Q1; 2: run Q2; 3: run Bonus; 4: run Extra Credit
...
def main():
    ...
    while True:
        ...
        #TODO: Extra Credit: bouncing camera movement
